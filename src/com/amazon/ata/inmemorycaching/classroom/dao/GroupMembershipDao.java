...
public class GroupMembershipDao {
    ...
    public boolean isUserInGroup(GroupMembershipCacheKey groupMembershipCacheKey) {
        return isUserInGroup(groupMembershipCacheKey.getUserId(), groupMembershipCacheKey.getGroupId());
    }
